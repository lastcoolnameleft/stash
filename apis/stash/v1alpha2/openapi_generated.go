...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/appscode/stash/apis/stash/v1alpha2.ContainerTemplate":     schema_stash_apis_stash_v1alpha2_ContainerTemplate(ref),
		"github.com/appscode/stash/apis/stash/v1alpha2.ContainerTemplateList": schema_stash_apis_stash_v1alpha2_ContainerTemplateList(ref),
		"github.com/appscode/stash/apis/stash/v1alpha2.ContainerTemplateSpec": schema_stash_apis_stash_v1alpha2_ContainerTemplateSpec(ref),
...
func schema_stash_apis_stash_v1alpha2_BackupSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					"type": {
						SchemaProps: spec.SchemaProps{
							Description: "Type indicates weather backup is Scheduled or OneTime",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"backupAgent": {
						SchemaProps: spec.SchemaProps{
							Description: "BackupAgent specify the ContainerTemplate that will be used for backup sidecar or job",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"containerAttributes": {
						SchemaProps: spec.SchemaProps{
							Description: "ContainerAttributes allow to specify Env, Resources, SecurityContext etc. for backup sidecar or job's container",
		...
		Dependencies: []string{
			"github.com/appscode/stash/apis/stash/v1alpha2.RetentionPolicy", "k8s.io/api/core/v1.Container", "k8s.io/api/core/v1.LocalObjectReference", "k8s.io/api/core/v1.ObjectReference"},
	}
}
...
func schema_stash_apis_stash_v1alpha2_BackupTemplateSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/appscode/stash/apis/stash/v1alpha2.RetentionPolicy", "k8s.io/api/core/v1.Container", "k8s.io/api/core/v1.LocalObjectReference", "kmodules.xyz/objectstore-api/api/v1.Backend"},
	}
}
...
func schema_stash_apis_stash_v1alpha2_ContainerTemplate(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/appscode/stash/apis/stash/v1alpha2.ContainerTemplateSpec"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/appscode/stash/apis/stash/v1alpha2.ContainerTemplateSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_stash_apis_stash_v1alpha2_ContainerTemplateList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/appscode/stash/apis/stash/v1alpha2.ContainerTemplate"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/appscode/stash/apis/stash/v1alpha2.ContainerTemplate", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_stash_apis_stash_v1alpha2_ContainerTemplateSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
...
func schema_stash_apis_stash_v1alpha2_RecoverySpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/appscode/stash/apis/stash/v1alpha2.RecoveryTarget", "k8s.io/api/core/v1.Container", "k8s.io/api/core/v1.LocalObjectReference", "k8s.io/api/core/v1.ObjectReference"},
	}
}
...
func schema_stash_apis_stash_v1alpha2_RecoveryTarget(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.ObjectReference", "kmodules.xyz/objectstore-api/api/v1.LocalSpec"},
	}
}
