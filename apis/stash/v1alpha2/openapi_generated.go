...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/appscode/stash/apis/stash/v1alpha2.AgentTemplate":       schema_stash_apis_stash_v1alpha2_AgentTemplate(ref),
		"github.com/appscode/stash/apis/stash/v1alpha2.AgentTemplateList":   schema_stash_apis_stash_v1alpha2_AgentTemplateList(ref),
		"github.com/appscode/stash/apis/stash/v1alpha2.AgentTemplateSpec":   schema_stash_apis_stash_v1alpha2_AgentTemplateSpec(ref),
		"github.com/appscode/stash/apis/stash/v1alpha2.Backup":              schema_stash_apis_stash_v1alpha2_Backup(ref),
		"github.com/appscode/stash/apis/stash/v1alpha2.BackupList":          schema_stash_apis_stash_v1alpha2_BackupList(ref),
		"github.com/appscode/stash/apis/stash/v1alpha2.BackupSpec":          schema_stash_apis_stash_v1alpha2_BackupSpec(ref),
		...
		"github.com/appscode/stash/apis/stash/v1alpha2.BackupTrigger":       schema_stash_apis_stash_v1alpha2_BackupTrigger(ref),
		"github.com/appscode/stash/apis/stash/v1alpha2.BackupTriggerList":   schema_stash_apis_stash_v1alpha2_BackupTriggerList(ref),
		"github.com/appscode/stash/apis/stash/v1alpha2.BackupTriggerSpec":   schema_stash_apis_stash_v1alpha2_BackupTriggerSpec(ref),
		"github.com/appscode/stash/apis/stash/v1alpha2.BackupTriggerStatus": schema_stash_apis_stash_v1alpha2_BackupTriggerStatus(ref),
		...
		"github.com/appscode/stash/apis/stash/v1alpha2.LocalTypedReference": schema_stash_apis_stash_v1alpha2_LocalTypedReference(ref),
		...
		"github.com/appscode/stash/apis/stash/v1alpha2.TriggerStats":        schema_stash_apis_stash_v1alpha2_TriggerStats(ref),
...
func schema_stash_apis_stash_v1alpha2_AgentTemplate(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/appscode/stash/apis/stash/v1alpha2.AgentTemplateSpec"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/appscode/stash/apis/stash/v1alpha2.AgentTemplateSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_stash_apis_stash_v1alpha2_AgentTemplateList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/appscode/stash/apis/stash/v1alpha2.AgentTemplate"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/appscode/stash/apis/stash/v1alpha2.AgentTemplate", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_stash_apis_stash_v1alpha2_AgentTemplateSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
...
func schema_stash_apis_stash_v1alpha2_Backup(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/appscode/stash/apis/stash/v1alpha2.BackupSpec"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/appscode/stash/apis/stash/v1alpha2.BackupSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_stash_apis_stash_v1alpha2_BackupList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/appscode/stash/apis/stash/v1alpha2.Backup"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/appscode/stash/apis/stash/v1alpha2.Backup", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_stash_apis_stash_v1alpha2_BackupSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					...
					"backupAgent": {
						SchemaProps: spec.SchemaProps{
							Description: "BackupAgent specify the AgentTemplate that will be used for backup sidecar or job",
					...
					"paused": {
						SchemaProps: spec.SchemaProps{
							Description: "Indicates that the Backup is paused from taking backup. Default value is 'false'",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
				...
				Required: []string{"repository", "targetRef"},
			},
		},
		Dependencies: []string{
			"github.com/appscode/stash/apis/stash/v1alpha2.ContainerAttributes", "github.com/appscode/stash/apis/stash/v1alpha2.PodAttributes", "github.com/appscode/stash/apis/stash/v1alpha2.RetentionPolicy", "github.com/appscode/stash/apis/stash/v1alpha2.WorkloadRef", "k8s.io/api/core/v1.LocalObjectReference"},
	}
}
...
func schema_stash_apis_stash_v1alpha2_BackupTrigger(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/appscode/stash/apis/stash/v1alpha2.BackupTriggerSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/appscode/stash/apis/stash/v1alpha2.BackupTriggerStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/appscode/stash/apis/stash/v1alpha2.BackupTriggerSpec", "github.com/appscode/stash/apis/stash/v1alpha2.BackupTriggerStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_stash_apis_stash_v1alpha2_BackupTriggerList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/appscode/stash/apis/stash/v1alpha2.BackupTrigger"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/appscode/stash/apis/stash/v1alpha2.BackupTrigger", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_stash_apis_stash_v1alpha2_BackupTriggerSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					"targetBackup": {
						SchemaProps: spec.SchemaProps{
							Description: "TargetBackup indicates the backup crd that will be triggered",
							Ref:         ref("k8s.io/api/core/v1.LocalObjectReference"),
						},
					},
				},
				Required: []string{"targetBackup"},
			},
		},
		Dependencies: []string{
...
func schema_stash_apis_stash_v1alpha2_BackupTriggerStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					...
					"stats": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/appscode/stash/apis/stash/v1alpha2.TriggerStats"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/appscode/go/encoding/json/types.IntHash", "github.com/appscode/stash/apis/stash/v1alpha2.TriggerStats"},
	}
}
...
func schema_stash_apis_stash_v1alpha2_LocalTypedReference(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_stash_apis_stash_v1alpha2_TriggerStats(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
