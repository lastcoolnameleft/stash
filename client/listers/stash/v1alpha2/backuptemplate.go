...
// List lists all BackupTemplates in the indexer.
func (s *backupTemplateLister) List(selector labels.Selector) (ret []*v1alpha2.BackupTemplate, err error) {
...
func (s *backupTemplateLister) Get(name string) (*v1alpha2.BackupTemplate, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha2.Resource("backuptemplate"), name)
	}
	return obj.(*v1alpha2.BackupTemplate), nil
}
