...
type BackupLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha2.Backup, err error)
...
// List lists all Backups in the indexer.
func (s *backupLister) List(selector labels.Selector) (ret []*v1alpha2.Backup, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha2.Backup))
	})
	return ret, err
}
...
type BackupNamespaceLister interface {
	...
	Get(name string) (*v1alpha2.Backup, error)
...
// List lists all Backups in the indexer for a given namespace.
func (s backupNamespaceLister) List(selector labels.Selector) (ret []*v1alpha2.Backup, err error) {
...
// Get retrieves the Backup from the indexer for a given namespace and name.
func (s backupNamespaceLister) Get(name string) (*v1alpha2.Backup, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha2.Resource("backup"), name)
	}
	return obj.(*v1alpha2.Backup), nil
}
