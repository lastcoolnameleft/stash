...
type BackupConfigurationLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha2.BackupConfiguration, err error)
...
// List lists all BackupConfigurations in the indexer.
func (s *backupConfigurationLister) List(selector labels.Selector) (ret []*v1alpha2.BackupConfiguration, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha2.BackupConfiguration))
	})
	return ret, err
}
...
type BackupConfigurationNamespaceLister interface {
	...
	Get(name string) (*v1alpha2.BackupConfiguration, error)
...
// List lists all BackupConfigurations in the indexer for a given namespace.
func (s backupConfigurationNamespaceLister) List(selector labels.Selector) (ret []*v1alpha2.BackupConfiguration, err error) {
...
// Get retrieves the BackupConfiguration from the indexer for a given namespace and name.
func (s backupConfigurationNamespaceLister) Get(name string) (*v1alpha2.BackupConfiguration, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha2.Resource("backupconfiguration"), name)
	}
	return obj.(*v1alpha2.BackupConfiguration), nil
}
