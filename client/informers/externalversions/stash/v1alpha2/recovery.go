...
type RecoveryInformer interface {
	...
	Lister() v1alpha2.RecoveryLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.StashV1alpha2().Recoveries(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.StashV1alpha2().Recoveries(namespace).Watch(options)
			},
		},
		&stashv1alpha2.Recovery{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *recoveryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&stashv1alpha2.Recovery{}, f.defaultInformer)
}

func (f *recoveryInformer) Lister() v1alpha2.RecoveryLister {
	return v1alpha2.NewRecoveryLister(f.Informer().GetIndexer())
}
