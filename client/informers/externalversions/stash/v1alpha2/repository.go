...
type RepositoryInformer interface {
	...
	Lister() v1alpha2.RepositoryLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.StashV1alpha2().Repositories(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.StashV1alpha2().Repositories(namespace).Watch(options)
			},
		},
		&stashv1alpha2.Repository{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *repositoryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&stashv1alpha2.Repository{}, f.defaultInformer)
}

func (f *repositoryInformer) Lister() v1alpha2.RepositoryLister {
	return v1alpha2.NewRepositoryLister(f.Informer().GetIndexer())
}
