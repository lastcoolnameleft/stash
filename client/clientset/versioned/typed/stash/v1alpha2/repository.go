...
type RepositoryInterface interface {
	Create(*v1alpha2.Repository) (*v1alpha2.Repository, error)
	Update(*v1alpha2.Repository) (*v1alpha2.Repository, error)
	UpdateStatus(*v1alpha2.Repository) (*v1alpha2.Repository, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha2.Repository, error)
	List(opts v1.ListOptions) (*v1alpha2.RepositoryList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.Repository, err error)
	RepositoryExpansion
}
...
func newRepositories(c *StashV1alpha2Client, namespace string) *repositories {
	return &repositories{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *repositories) Get(name string, options v1.GetOptions) (result *v1alpha2.Repository, err error) {
	result = &v1alpha2.Repository{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *repositories) List(opts v1.ListOptions) (result *v1alpha2.RepositoryList, err error) {
	result = &v1alpha2.RepositoryList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("repositories").
...
func (c *repositories) Create(repository *v1alpha2.Repository) (result *v1alpha2.Repository, err error) {
	result = &v1alpha2.Repository{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("repositories").
...
func (c *repositories) Update(repository *v1alpha2.Repository) (result *v1alpha2.Repository, err error) {
	result = &v1alpha2.Repository{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("repositories").
...
func (c *repositories) UpdateStatus(repository *v1alpha2.Repository) (result *v1alpha2.Repository, err error) {
	result = &v1alpha2.Repository{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("repositories").
...
func (c *repositories) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.Repository, err error) {
	result = &v1alpha2.Repository{}
