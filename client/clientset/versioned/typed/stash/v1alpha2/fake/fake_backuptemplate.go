...
var backuptemplatesKind = schema.GroupVersionKind{Group: "stash.appscode.com", Version: "v1alpha2", Kind: "BackupTemplate"}
...
func (c *FakeBackupTemplates) Get(name string, options v1.GetOptions) (result *v1alpha2.BackupTemplate, err error) {
	...
	return obj.(*v1alpha2.BackupTemplate), err
}
...
func (c *FakeBackupTemplates) List(opts v1.ListOptions) (result *v1alpha2.BackupTemplateList, err error) {
	...
	list := &v1alpha2.BackupTemplateList{ListMeta: obj.(*v1alpha2.BackupTemplateList).ListMeta}
	for _, item := range obj.(*v1alpha2.BackupTemplateList).Items {
