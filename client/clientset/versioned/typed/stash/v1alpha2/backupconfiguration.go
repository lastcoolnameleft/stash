...
type BackupConfigurationInterface interface {
	Create(*v1alpha2.BackupConfiguration) (*v1alpha2.BackupConfiguration, error)
	Update(*v1alpha2.BackupConfiguration) (*v1alpha2.BackupConfiguration, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha2.BackupConfiguration, error)
	List(opts v1.ListOptions) (*v1alpha2.BackupConfigurationList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.BackupConfiguration, err error)
...
func newBackupConfigurations(c *StashV1alpha2Client, namespace string) *backupConfigurations {
...
func (c *backupConfigurations) Get(name string, options v1.GetOptions) (result *v1alpha2.BackupConfiguration, err error) {
	result = &v1alpha2.BackupConfiguration{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *backupConfigurations) List(opts v1.ListOptions) (result *v1alpha2.BackupConfigurationList, err error) {
	result = &v1alpha2.BackupConfigurationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("backupconfigurations").
...
func (c *backupConfigurations) Create(backupConfiguration *v1alpha2.BackupConfiguration) (result *v1alpha2.BackupConfiguration, err error) {
	result = &v1alpha2.BackupConfiguration{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("backupconfigurations").
...
func (c *backupConfigurations) Update(backupConfiguration *v1alpha2.BackupConfiguration) (result *v1alpha2.BackupConfiguration, err error) {
	result = &v1alpha2.BackupConfiguration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("backupconfigurations").
...
func (c *backupConfigurations) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.BackupConfiguration, err error) {
	result = &v1alpha2.BackupConfiguration{}
