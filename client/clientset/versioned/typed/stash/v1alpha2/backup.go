...
type BackupInterface interface {
	Create(*v1alpha2.Backup) (*v1alpha2.Backup, error)
	Update(*v1alpha2.Backup) (*v1alpha2.Backup, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha2.Backup, error)
	List(opts v1.ListOptions) (*v1alpha2.BackupList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.Backup, err error)
	BackupExpansion
}
...
func newBackups(c *StashV1alpha2Client, namespace string) *backups {
	return &backups{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *backups) Get(name string, options v1.GetOptions) (result *v1alpha2.Backup, err error) {
	result = &v1alpha2.Backup{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("backups").
		Name(name).
...
func (c *backups) List(opts v1.ListOptions) (result *v1alpha2.BackupList, err error) {
	result = &v1alpha2.BackupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("backups").
...
func (c *backups) Create(backup *v1alpha2.Backup) (result *v1alpha2.Backup, err error) {
	result = &v1alpha2.Backup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("backups").
...
func (c *backups) Update(backup *v1alpha2.Backup) (result *v1alpha2.Backup, err error) {
	result = &v1alpha2.Backup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("backups").
...
func (c *backups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.Backup, err error) {
	result = &v1alpha2.Backup{}
