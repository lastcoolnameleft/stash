...
type BackupTemplateInterface interface {
	Create(*v1alpha2.BackupTemplate) (*v1alpha2.BackupTemplate, error)
	Update(*v1alpha2.BackupTemplate) (*v1alpha2.BackupTemplate, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha2.BackupTemplate, error)
	List(opts v1.ListOptions) (*v1alpha2.BackupTemplateList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.BackupTemplate, err error)
	BackupTemplateExpansion
}
