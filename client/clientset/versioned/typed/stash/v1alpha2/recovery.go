...
type RecoveryInterface interface {
	Create(*v1alpha2.Recovery) (*v1alpha2.Recovery, error)
	Update(*v1alpha2.Recovery) (*v1alpha2.Recovery, error)
	UpdateStatus(*v1alpha2.Recovery) (*v1alpha2.Recovery, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha2.Recovery, error)
	List(opts v1.ListOptions) (*v1alpha2.RecoveryList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.Recovery, err error)
	RecoveryExpansion
}
...
func newRecoveries(c *StashV1alpha2Client, namespace string) *recoveries {
	return &recoveries{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *recoveries) Get(name string, options v1.GetOptions) (result *v1alpha2.Recovery, err error) {
	result = &v1alpha2.Recovery{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("recoveries").
		Name(name).
...
func (c *recoveries) List(opts v1.ListOptions) (result *v1alpha2.RecoveryList, err error) {
	result = &v1alpha2.RecoveryList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("recoveries").
...
func (c *recoveries) Create(recovery *v1alpha2.Recovery) (result *v1alpha2.Recovery, err error) {
	result = &v1alpha2.Recovery{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("recoveries").
...
func (c *recoveries) Update(recovery *v1alpha2.Recovery) (result *v1alpha2.Recovery, err error) {
	result = &v1alpha2.Recovery{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("recoveries").
...
func (c *recoveries) UpdateStatus(recovery *v1alpha2.Recovery) (result *v1alpha2.Recovery, err error) {
	result = &v1alpha2.Recovery{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("recoveries").
...
func (c *recoveries) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.Recovery, err error) {
	result = &v1alpha2.Recovery{}
